...
export async function generateCoachFeedback(question, conversationHistory = [], scores = null, questionType = null, companyMode = null) {
  ...
  const dimensionPriority = {
    ...
    google_product_sense: 'For Google L6 Round 1, Opinion Clarity is the most critical dimension — a candidate who cannot commit to a problem, vision, or hypothesis fails this round. Lead coaching with Opinion Clarity gaps first. Then Structure — did they complete all 8 sections or skip MVP scope, metrics, or risks? Then Specificity — was every section concrete and named or generic? Then Depth Under Pressure — did they hold their positions when challenged?',
  };
